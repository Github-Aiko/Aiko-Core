...
// A Command is an implementation of a Aiko command
// like Aiko run or Aiko version.
type Command struct {
...
// LongName returns the command's long name: all the words in the usage line between first word (e.g. "Aiko") and a flag or argument,
...
func (c *Command) Usage() {
	...
	fmt.Fprintf(os.Stderr, "Run 'Aiko help %s' for details.\n", c.LongName())
	SetExitStatus(2)
	Exit()
}
