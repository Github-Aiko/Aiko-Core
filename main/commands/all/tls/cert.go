...
var (
	...
	certCommonName   = cmdCert.Flag.String("name", "Aiko Inc", "The common name of this certificate")
	certOrganization = cmdCert.Flag.String("org", "Aiko Inc", "Organization of the certificate")
