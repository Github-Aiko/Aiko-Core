...
import (
	serial "github.com/Github-Aiko/Aiko-Core/common/serial"
...
type TransportConfig struct {
	...
	Protocol TransportProtocol `protobuf:"varint,1,opt,name=protocol,proto3,enum=Aiko.transport.internet.TransportProtocol" json:"protocol,omitempty"`
	// Type of network that this settings supports.
...
type SocketConfig struct {
	...
	Tproxy SocketConfig_TProxyMode `protobuf:"varint,3,opt,name=tproxy,proto3,enum=Aiko.transport.internet.SocketConfig_TProxyMode" json:"tproxy,omitempty"`
	...
	DomainStrategy             DomainStrategy `protobuf:"varint,8,opt,name=domain_strategy,json=domainStrategy,proto3,enum=Aiko.transport.internet.DomainStrategy" json:"domain_strategy,omitempty"`
...
var file_transport_internet_config_proto_goTypes = []interface{}{
	(TransportProtocol)(0),       // 0: Aiko.transport.internet.TransportProtocol
	(DomainStrategy)(0),          // 1: Aiko.transport.internet.DomainStrategy
	(SocketConfig_TProxyMode)(0), // 2: Aiko.transport.internet.SocketConfig.TProxyMode
	(*TransportConfig)(nil),      // 3: Aiko.transport.internet.TransportConfig
	(*StreamConfig)(nil),         // 4: Aiko.transport.internet.StreamConfig
	(*ProxyConfig)(nil),          // 5: Aiko.transport.internet.ProxyConfig
	(*SocketConfig)(nil),         // 6: Aiko.transport.internet.SocketConfig
	(*serial.TypedMessage)(nil),  // 7: Aiko.common.serial.TypedMessage
}
var file_transport_internet_config_proto_depIdxs = []int32{
	0, // 0: Aiko.transport.internet.TransportConfig.protocol:type_name -> Aiko.transport.internet.TransportProtocol
	7, // 1: Aiko.transport.internet.TransportConfig.settings:type_name -> Aiko.common.serial.TypedMessage
	0, // 2: Aiko.transport.internet.StreamConfig.protocol:type_name -> Aiko.transport.internet.TransportProtocol
	3, // 3: Aiko.transport.internet.StreamConfig.transport_settings:type_name -> Aiko.transport.internet.TransportConfig
	7, // 4: Aiko.transport.internet.StreamConfig.security_settings:type_name -> Aiko.common.serial.TypedMessage
	6, // 5: Aiko.transport.internet.StreamConfig.socket_settings:type_name -> Aiko.transport.internet.SocketConfig
	2, // 6: Aiko.transport.internet.SocketConfig.tproxy:type_name -> Aiko.transport.internet.SocketConfig.TProxyMode
	1, // 7: Aiko.transport.internet.SocketConfig.domain_strategy:type_name -> Aiko.transport.internet.DomainStrategy
