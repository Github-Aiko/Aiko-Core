...
var file_common_net_port_proto_goTypes = []interface{}{
	(*PortRange)(nil), // 0: Aiko.common.net.PortRange
	(*PortList)(nil),  // 1: Aiko.common.net.PortList
}
var file_common_net_port_proto_depIdxs = []int32{
	0, // 0: Aiko.common.net.PortList.range:type_name -> Aiko.common.net.PortRange
